...
@section('content')
    ...
    <div class="row">
        <form role="form" class="validate" action="{{route('orders-out.store')}}" method="POST"
    ...
    <script>
        ...
        $('#add').on('click', function () {
            ...
            $('<tr>').html(
                ...
                '<td><input type="text" readonly class="form-control text-center" value="' + item_name + '"><input type="hidden" required="required" name="item_id[]" value="' + item_id + '"></td>' +
