...
<div class="row">
  <div class="col-md-12">
    <div class="box box-primary">
        ...
        <div class="table-responsive">
          <table class="table table table-bordered">
            ...
            <tr>
              ...
              <td>{{$resource->ownerable? optional($resource->ownerable)->name: ''}}</td>
              <td>{{$resource->ownerable? optional($resource->ownerable)->phone_1: ''}}</td>
      ...
      <div class="box-body">
        {{Form::open(['route'=>['return-orders-out.update',$resource->id],'method'=>'PUT'])}}
        <div class="row">
          <div class="col-md-12">
          ...
          <tr>
            ...
            @php
              if($order_detail->is_oper_supplies == 1){
                  $item = DB::table('supplies')->where('id', $order_detail->item->id)->first();
                  $item_name = $item ? $item->name : '-'; // Ensure it's a string
              } else {
