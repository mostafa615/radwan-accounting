  ...
  <div class="col-md-12">
    <div class="box box-primary">
      <div class="box-header with-border">
        <h3 class="box-title">فواتير البيع</h3>
        <div class="box-btn">
          ...
          <div class="row">
            <div class="col-xs-6">
              <div class="col-lg-3 col-md-3 col-sm-12" style="margin-top: 20px;">
                <div class="form-group">
                  <?php
                    $pendingOrders = App\Models\Order::where('type', 'in')
              ...
              <div class="col-lg-3 col-md-3 col-sm-12" style="margin-top: 20px;">
                <div class="form-group">
                  <?php
                    $refusedOrders = App\Models\Order::where('type', 'in')
                    ...
                    $refusedOrdersCount = $refusedOrders->get();
                  ?>
                  <a class="btn btn-danger btn-sm btn-flat" href="?status=3">
                    الفواتير المرفوضة <span class="badge badge-light">{{$refusedOrdersCount->count()}}</span>
                  </a>
                </div>
              </div>
              <div class="col-lg-3 col-md-3 col-sm-12" style="margin-top: 20px;">
                  ...
                  @if(Auth::user()->hasRole('admin') || Auth::user()->branch_id == $resource->branch_id)
                    @if(Auth::user()->can('edit_order') && Auth::user()->has_edit_orders == 1)
                      @if(\App\Models\Order::where('id', $resource->id)->whereHas('orderDetails', function ($query) {
                        ...
                        <a href="{{url('orders-in/'.$resource->id.'/edit')}}" class="btn btn-warning"><i class="fa fa-edit"></i></a>
                      @endif
                    @endif
                        ...
                        <div id="delete_{{$resource->id}}" class="modal fade" role="dialog">
                          <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                              ...
                              <div class="modal-footer">
                                {{Form::open(['route'=>['orders-in.destroy', $resource->id],'method'=>'DELETE'])}}
