  ...
  <div class="col-md-12">
    <div class="box box-primary">
      <div class="box-header with-border">
        <h3 class="box-title">تعديل فاتورة بيع </h3>
      </div>
      <div class="box-body">
      ...
      <div class="box-body">
        {{Form::open(['route'=>['orders-in.update',$resource->id],'method'=>'PUT'])}}
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <select name="driver_id" id="driver_id" class="form-control">
                ...
                <option value="{{$driver->id}}" {{$driver->id == $resource->driver_id ? 'selected' : 'null'}}>{{$driver->name}}</option>
                @endforeach
              </select>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="number" min="0" step="any" value="{{$resource->driving_cost}}"
                class="form-control observe" name="driving_cost" id="driving_cost">
            </div>
          </div>
        </div>
        <div class="row">
