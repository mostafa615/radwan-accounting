    ...
    <div class="row">
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" class="validate" action="{{route('mandators.store')}}" method="POST" enctype="multipart/form-data">
            {{csrf_field()}}
              <div class="box-body">
            ...
            phone_1:{
              remote:{
                  ...
                  data:{
                      ...
                      method:'unique:mandators,phone_1|unique:mandators,phone_2|unique:mandators,phone_3',
                  }
                  }
          },
            phone_2:{
