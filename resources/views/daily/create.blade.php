      ...
      @if($reposites->count())
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form  action="{{route('daily.add')}}" method="POST" >
            {{csrf_field()}}
            ...
            <input type="hidden" name="tree_id" value="">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input type="text" required class="form-control date" value="{{\Carbon\Carbon::now()->format('Y-m-d')}}" name="date" id="date" autocomplete="off">
                      @else
                      <input type="text" required class="form-control" value="{{\Carbon\Carbon::now()->format('Y-m-d')}}" name="date" id="date" autocomplete="off" readonly>
                      @endif
                    </div>
              ...
              <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input type="text"  required class="form-control" name="cost">
                    </div>
              ...
              <div class="box-footer">
                <div class="text-danger text-bold">
                  <div class="form-group">
                    <input type="text" disabled name="selectedItem" class="form-control" style="width: 300px">
                  </div>
                </div>
...
<script>
  $(document).ready(function(){
    ...
    // Update Here
    var fullPath = node.instance.get_path(node.node, ' / ');
    $('[name=selectedItem]').val(fullPath)
