                            ...
                            <table class="table table-bordered datatable-no-paging" style="width: 100%!important" id="item-report-table2" >
                               ...
                               <tbody>
                                ...
                                @foreach($orders_in as $item)
                                    ...
                                    ?>
                                    <tr data-amount="-{{$item->quantity}}" class="amount-row" > 
                                        <td>{{optional($item->order)->date}}</td>
                                        <td>{{$item->quantity}}</td> 
                                        <td>0</td>
                                        <td>0</td>
                                ...
                                @foreach($to_factory as $item)
                                    ...
                                    ?>
                                    <tr data-amount="-{{$resultQnt}}" class="amount-row" > 
                                        <td  >{{$date}}</td>
                                        <td>0</td>
                                        <td>0</td>
                                        <td>0</td>
                                ...
                                @foreach($from_factory as $item)
                                    <?php
                                        ...
                                        $date = DB::table('operation_orders')->where('id', $item->operation_order_id)->first()->date;
                                    ?>
                                    <tr data-amount="{{$item->actual_output}}" class="amount-row" > 
                                        <td  >{{$date}}</td>
                                        <td>0</td>
                                        <td>0</td>
                                        <td>0</td>
                                ...
                                @foreach($scrap_factory as $item)
                                    <?php
                                        ...
                                        $date = DB::table('operation_orders')->where('id', $item->operation_order_id)->first()->date;
                                    ?>
                                    <tr data-amount="-{{$item->damage_weight}}" class="amount-row" > 
                                        <td  >{{$date}}</td>
                                        <td>0</td>
                                        <td>0</td>
                                        <td>0</td>
