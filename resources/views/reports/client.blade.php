                                    ...
                                    <table class="table table-bordered" id="example_8">
                                        ...
                                        @if( $client != null && $client != '')
                                            ...
                                            <tr>
                                                ...
                                                <td id="balance"><?php echo number_format($balance, 2) ?></td>
                                            </tr>
                                        @endif
                                    </table>
                                </div>
            ...
            <div class="modal fade" id="modal" tabindex="-1" role="dialog" aria-labelledby="modalLabel">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form action="{{url('reports/client')}}" method="GET">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input required type="text" class="form-control date" name="from" id="from"
                                                   autocomplete="off" value="{{Carbon\Carbon::now()->startOfMonth()->format('Y-m-d')}}">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
