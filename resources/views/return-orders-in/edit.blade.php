...
<div class="row">
  <div class="col-md-12">
    <div class="box box-primary">
      ...
      <div class="box-body">
        {{Form::open(['route'=>['return-orders-in.update',$resource->id],'method'=>'PUT'])}}
        <div class="row">
          <div class="col-md-6">
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="number" min="0" step="any" value="{{$resource->driving_cost}}" class="form-control observe" name="driving_cost" id="driving_cost">
            </div>
          </div>
        </div>
        <div class="row">
