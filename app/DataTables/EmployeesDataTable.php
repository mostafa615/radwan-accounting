    ...
    protected function getColumns()
    {
        return [
            ...
            [
                ...
                'data' => null,
                'render' => 'function() {
                    return `<input type="checkbox" name="option" value="${data.id}" onchange="sendStatus(${data.id})" id="option_${data.id}" ${data.summer_holiday_permission == 1 ? "checked" : "" }>`;
                }',
                'exportable' => false,
                'printable' => false,
                'searchable' => false,
                'orderable' => false,
                'title' => 'تفعيل اجازة المصيف',
            ],
            [
                'name'=>'action',
                'data'=>'action',
